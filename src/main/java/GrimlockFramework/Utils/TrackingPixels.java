...
public  final class TrackingPixels {
    ...
    public static String[] PixelsFromQuery = {"EC=7", "EC=15","Ee=1", "RcpF=1", "EC=40", "EC=3&", "EC=38", "EC=2", "Eipct=0", "Eipct=25", "Eipct=50", "Eipct=75", "Eipct=100",
            ...
            , "param1=MediaProgress_LongformGreen_0", "param1=MediaProgress_LongformGreen_25", "param1=MediaProgress_LongformGreen_50", "param1=MediaProgress_LongformGreen_75", "param1=MediaProgress_LongformGreen_100","param1=Interact_AgeGateFail_Click","EaC=Interact_AgeGateFail_Click","param1=MediaProgress_Longform_0","param1=MediaProgress_Longform_25",
            "param1=MediaProgress_Longform_50","param1=MediaProgress_Longform_75","param1=MediaProgress_Longform_100"};
    ...
    public static final Map<String, Integer> CUSTOM_PIXEL_MAP = new HashMap<String, Integer>() {
        {
    ...
    public static final Map<String, Integer> REG3202_CUSTOM_PIXEL_MAP = new HashMap<String, Integer>() {
        {
            put("param1=creative_impression", 2);
            put("param1=screen_impression", 2);
    ...
    public static final Map<String, Integer> PXP_LONGFORM_PROGRESS_PIXEL_MAP = new HashMap<String, Integer>() {
        {
            put("param1=MediaProgress_Longform_0", 1);
            put("param1=MediaProgress_Longform_25", 1);
            put("param1=MediaProgress_Longform_50", 1);
            put("param1=MediaProgress_Longform_75", 1);
            put("param1=MediaProgress_Longform_100", 1);
    ...
    public static final Map<String, Integer> SPR_CLICK_SLATE_PIXEL_MAP = new HashMap<String, Integer>() {
        {
    ...
    public static final Map<String, Integer> PXP_AGEGATE_NO_PIXEL_MAP = new HashMap<String, Integer>() {
        {
            put("EaC=Interact_AgeGateFail_Click", 1);
